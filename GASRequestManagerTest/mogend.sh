...
mogenerator --model "${INPUT_FILE_PATH}/$curVer" --machine-dir "${PROJECT_DIR}/GASRequestManagerTest/Models/Private/" --human-dir "${PROJECT_DIR}/GASRequestManagerTest/Models/" --template-var arc=true
