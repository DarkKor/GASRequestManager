...
mogenerator --model "${INPUT_FILE_PATH}" --machine-dir "${PROJECT_DIR}/GASRequestManagerTest/Models/Private/" --human-dir "${PROJECT_DIR}/GASRequestManagerTest/Models/" --template-var arc=true
